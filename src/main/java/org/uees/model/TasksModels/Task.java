...
public class Task {
    ...
    public Task(int id, String description, LocalDateTime dueDate, Priority priority) {
        this.id = id;
    ...
    public Task(int id, String description, LocalDateTime dueDate, Priority priority, String listName) {
